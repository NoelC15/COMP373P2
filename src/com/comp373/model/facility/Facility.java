...
// private MaintIssue currentMaintIssue; //make this null when curr issue is
// resolved
//
// //interfaces
...
// this.openDate =
// dateFormat.parse(Integer.toString(year)+"/"+Integer.toString(month)+"/"+Integer.toString(day));
// }
//
