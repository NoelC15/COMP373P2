...
public class GymLeaderImpl extends HumanImpl implements GymLeader {

	private List<Pokemon> pokemon;
	private Gym gym;

	public GymLeaderImpl() {

	}

	public GymLeaderImpl(String fName, String lName, BankAccount account, int badges, List<Pokemon> pocketMonsters,
			long id, Gym gym) {
