...
public class TrainerImpl extends HumanImpl implements Trainer {
	...
	public TrainerImpl(String fName, String lName, BankAccount account, int badges, List<Pokemon> pocketMonsters,
			long id) {
