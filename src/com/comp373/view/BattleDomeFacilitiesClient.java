...
public class BattleDomeFacilitiesClient {
	...
	// TODO: add interface to classes that need it (Pokemon, Gym, GymLeader, etc.)
	/**
	 * @param args
	 * @throws Exception
	 */
...
//        Manager manager = new Manager();
        HumanImpl manager = (Manager) context.getBean("manager");
...
//        BankAccount mangBankAccount = new BankAccountImpl();
        ...
        TrainerImpl trainer = (TrainerImpl) context.getBean("trainer");
